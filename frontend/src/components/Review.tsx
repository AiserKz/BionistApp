          ...
          >
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-md text-base-content/70 leading-relaxed">
                ...
                <em>курица, 1800 ккал, больше белка</em>) и получите
                предложенную тарелку, список ингредиентов и совет по подаче.
              </p>

              <div className="rounded-lg bg-base-200 p-3 text-sm text-base-content/70">
                Пример ввода: <code>курица, 1800 ккал, больше белка</code>
              </div>
